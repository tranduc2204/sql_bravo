...
--k.	Tính doanh số bán hàng của từng mặt hàng trong từng tháng trong năm 2014



DROP PROC IF EXISTS usp_FILE5P2_k
GO 
CREATE PROC usp_FILE5P2_k
AS 
BEGIN
...
--k.	Tính doanh số bán hàng của từng mặt hàng trong từng tháng trong năm 2014
	...
	select TB2.Code, MAX (TB2.Name), SUM (Quantity * Amount) AS DOANHSO , MONTH(DocDate), YEAR (DocDate)
