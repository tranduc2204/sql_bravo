...
--t.	Tìm nhân viên không ai quản lý, không quản lý ai


DROP PROC IF EXISTS usp_FILE5P2_t
GO 
CREATE PROC usp_FILE5P2_t
AS 
BEGIN
...
--t.	Tìm nhân viên không ai quản lý, không quản lý ai
 --- code đầu là không quản lý ai 
	...
	where Code not in (
		...
		from #B20Employee 
		where ManagerCode is not null) and ManagerCode is null -- khúc này để kiếm không ai quản lý 
	;
