...
--f.	Tìm khách hàng mua hàng trong tháng 7 năm 2014


DROP PROC IF EXISTS usp_FILE5P2_f
GO 
CREATE PROC usp_FILE5P2_f
AS 
BEGIN
...
--f.	Tìm khách hàng mua hàng trong tháng 7 năm 2014
	select distinct tb2.Code, tb2.Name
	...
	SELECT * 
	FROM #B20Customer TB1
	JOIN #KHACHHANG TB2 
		ON TB1.Code = TB2.CustomerCode;
